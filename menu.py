...
notes = [{'username': 'Пользователь', 'title': 'Заголовок', 'content': 'Описание', 'status' : 'В процессе', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Список покупок', 'content': 'Купить продукты на неделю', 'status' : 'В процессе', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Спорт', 'content': 'Сходить в зал', 'status' : 'Выполнено', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Конный', 'content': 'Спорт', 'status' : 'Выполнено', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Конный', 'content': 'Спорт', 'status' : 'Отложено', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Конный', 'content': 'Спорт', 'status' : 'Отложено', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Конный', 'content': 'Спорт', 'status' : 'Отложено', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Конный', 'content': 'Спорт', 'status' : 'Отложено', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}, {'username': 'Мария', 'title': 'Конный', 'content': 'Спорт', 'status' : 'Отложено', 'created_date' : datetime.today(), 'issue_date' : datetime.today()}]
while True:
